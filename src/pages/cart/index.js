            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {itemsInCart.length > 0 ?
                    <div className="flex h-full flex-col overflow-y-scroll">
                        <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                            <div className="flex items-start justify-between">
                                <h2 className="text-lg font-body font-medium text-black dark:text-green"
                                                    ...
                                                    <div>
                                                        <div
                                                            ...
                                                            {item.discountedPrice < item.price ? (
                                                                ...
                                                                <p className="text-sm tracking-tight text-black dark:text-white my-10">{item.price} NOK</p>
                                                            )}
                                                        </div>
                                                    </div>
                                                    <div
                    ...
                    <div className=" flex  flex-col text-center p-8 shadow-lg">
                        ...
                        <div className=" my-10 flex items-center justify-center font-body rounded-lg border border-transparent bg-grey px-6 py-3 text-base font-light text-white shadow-sm">
                            <button type="button">
                                <Link to="/products" className='font-medium ml-1'>Continue Shopping</Link>
                            </button>
                        </div>
                    </div>}
            </div>
