			...
			{singleProduct && !isError && (
                <div className="bg-white dark:bg-primaryblue">
                    <div className="pt-10 py-10 flex flex-col lg:flex-row xl:justify-evenly items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
						<div className="md:grid md:grid-flow-col md:grid-rows-2 md:gap-8">
							<img
					...
					{singleProduct.reviews.length ? (
						singleProduct.reviews.map((review) => (
                            <div key={review.id} className="pb-11 mt-10 mx-auto max-w-7xl px-4 sm:px-0 ">
                                <div className="flex flex-col gap-5 text-black dark:text-white pt-11 md:mx-5 border-t border-black dark:border-green md:px-10">
                                    <h2 className="font-body text-xl lg:text-2xl">Reviews</h2>
